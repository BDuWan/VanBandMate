...
func startWeb() {
	...
	engine.AddFuncMap(fiber.Map{
		...
		"IsCheckCourse":         controllers.IsCheckCourse,
		"IsCheckStudyProgram":   controllers.IsCheckStudyProgram,
		"IsCheckClass":          controllers.IsCheckClass,
		"IsStudent":             controllers.IsStudent,
		"IsStudentCtx":          controllers.IsStudentCtx,
		"IsInstructorCtx":       controllers.IsInstructorCtx,
		"IsInstructor":          controllers.IsInstructor,
		"IsStudentOrInstructor": controllers.IsStudentOrInstructor,
		"StatusAssignment":      controllers.StatusAssignment,
		"IsSaleBusiness":        controllers.IsSaleBusiness,
		"IsSale":                controllers.IsSale,
		"IsBusiness":            controllers.IsBusiness,
