...
func RouteInit(app *fiber.App) {
	...
	app.Get("/login_sale", controllers.GetLoginSale)
	...
	app.Post("/login_sale", controllers.PostLoginSale)
	app.Post("/forgot-password", controllers.CreateNewPass)
	app.Post("/signup/stu", controllers.PostSignupStudent)
	app.Post("/signup/instr", controllers.PostSignupInstructor)
	app.Post("/signup/sale", controllers.PostSignupSale)
	app.Post("/signup/business", controllers.PostSignupBusiness)
